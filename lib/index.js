...
let DefaultServer = class DefaultServer {
    ...
    initialise({ api, logging, container, tokenValidation, publicDir = 'public', }) {
        ...
        this.server.setConfig(app => {
            ...
            app.use(express_1.default.static(path_1.default.join(__dirname, publicDir)));
        ...
        this.server.setErrorConfig(app => {
            ...
            app.get('*', (req, res) => {
                res.sendFile(path_1.default.join(__dirname, publicDir + '/index.html'));
            });
        });
    }
